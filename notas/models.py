...
class Product(TimeStampedModel, Active):
    maquina_pt = models.CharField(max_length=255, blank=True, null=True)
    ...
    tipo_pt = models.CharField(max_length=255, blank=True, null=True)
    tipo_en = models.CharField(max_length=255, blank=True, null=True)
    tipo_ch = models.CharField(max_length=255, blank=True, null=True)
    modelo_pt = models.CharField(max_length=255, blank=True, null=True)
    ...
    area_trabalho_pt = models.CharField(max_length=255, blank=True, null=True)
    ...
    eixo_z_pt = models.CharField(max_length=255, blank=True, null=True)
